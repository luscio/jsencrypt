...
var JSEncrypt = /** @class */ (function () {
     ...
     * @public
     */
    JSEncrypt.prototype.setKey = function (key, type) {
     ...
     * @public
     */
    JSEncrypt.prototype.decryptUnicodeLong = function (str) {
        var k = this.getKey();
        var maxLength = ((k.n.bitLength() + 7) >> 3) * 2;
        try {
            var hexString = b64tohex(str);
            var decryptedString = "";
     ...
     * @public
     */
    JSEncrypt.prototype.encryptUnicodeLong = function (str) {
        var k = this.getKey();
